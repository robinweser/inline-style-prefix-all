...
function flexboxIE(property, value) {
  if (properties.has(property) || property === 'display' && value.indexOf('flex') > -1) {
    ...
    if (alternativeValues[value]) {
      return _defineProperty({}, property, [alternativeValues[value], value].join(';' + property + ':'));
    }
  }
}
...
var _utilsDashToCamelCase = require('../utils/dashToCamelCase');

var _utilsDashToCamelCase2 = _interopRequireDefault(_utilsDashToCamelCase);
  ...
  if (typeof value === 'string' && properties.has(unprefixedProperty)) {
    ...
    var _ret = (function () {
      ...
      multipleValues.forEach(function (val, index) {
        var requiredPrefixes = Object.keys(_prefixProps2['default']).reduce(function (out, prefix) {
          if (_prefixProps2['default'][prefix].has((0, _utilsDashToCamelCase2['default'])(property))) {
            out.unshift(prefix);
          }
          return out;
        }, []);
        // join all prefixes and create a new value
        multipleValues[index] = requiredPrefixes.map(function (prefix) {
...
module.exports = exports['default'];
},{"../prefixProps":10,"../utils/camelToDashCase":12,"../utils/capitalizeString":13,"../utils/dashToCamelCase":14,"../utils/unprefixProperty":15}],9:[function(require,module,exports){
'use strict';
...
exports['default'] = function (property) {
  return property.toLowerCase().replace('-ms-', 'ms-').replace(/-(.)/g, function (match, p1) {
